...
failed eval runs; the remaining Phase 0 work is private fixture secret
provisioning/changelog discipline and richer failure-mode-targeted examples
under that gate.
