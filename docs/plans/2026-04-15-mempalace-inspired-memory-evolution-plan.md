...
6. **PR F: Drawer-Aware Search**
   ...
   - Delivered: CP drawer search + get index integration landed in PR #704, production embedding-client wiring landed in PR #707, the first web drawer-search page landed in PR #709, and gated facts-side drawer fusion landed in PR #712. Remaining: PR #716 hardening plus its missing facts-side sanitizer port, eval comparison, and no default enablement until metrics pass.
