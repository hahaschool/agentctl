...
snapshot;
the remaining Phase 0 work is private fixture secret provisioning/changelog
discipline and richer private held-out/full failure-mode examples under that
gate.
...
1. **PR A: Eval Harness**
   ...
   - Remaining: private fixture secret provisioning/changelog discipline and richer private held-out/full failure-mode examples.
