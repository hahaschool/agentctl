...
3. **PR C: Backfill**
   ...
   - Completed locally in `36288808`: execute-mode embedding generation/backfill for CLI-written facts plus bounded batching/backoff.
