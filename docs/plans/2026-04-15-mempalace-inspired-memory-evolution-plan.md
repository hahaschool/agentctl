...
`.github/workflows/memory-evals.yml`, and PR #796 adds the workflow/CLI
failure-mode coverage gate; the remaining Phase 0 work is private fixture
secret provisioning/changelog discipline and richer failure-mode-targeted
examples under that gate.
