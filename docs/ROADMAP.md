...
>
> Coordination note: PR #461 merged as `e6fd4c2e`, PR #462 as `193e6b02`, PR #465 as `2b950c96`, PR #466 as `9fbc2fe9`, PR #467 as `620de798`, PR #468 as `4291f520`, PR #470 as `5a480a23`, PR #471 as `2d61cb8a`, PR #472 as `7b2f9b8c`, PR #473 as `22fbe6ae`, PR #474 as `a8189309`, PR #475 as `1f4007c1`, PR #476 as `fa632acd`, PR #477 as `be1765d3`, PR #478 as `082deedb`, PR #479 as `9f984523`, PR #480 as `0f9fb538`, PR #481 as `0668db95`, PR #482 as `04e1e80d`, PR #483 as `88ccf816`, PR #485 as `071b7e3d`, PR #486 as `bfd9e74f`, PR #487 as `f28a2a85`, PR #488 as `eb9ae933`, PR #489 as `c01300b2`, PR #490 as `d868742b`, PR #491 as `f3ad66dc`, PR #492 as `8b716d6f`, PR #493 as `808556b0`, PR #494 as `95e7c8a2`, PR #495 as `5635abdf`, PR #496 as `64de9152`, PR #497 as `1b95f9f8`, PR #499 as `05972feb`, PR #498 as `3eebce46`, PR #500 as `e20e5682`, PR #501 as `d1c9635c`, PR #503 as `3b3ecf3f`, PR #504 as `8a9cda1b`, PR #505 as `bde0f343`, PR #506 as `caf3038f`, PR #507 as `d3fb1a0b`, PR #508 as `547fe24b`, PR #509 as `b0464f2c`, PR #510 as `3c694d79`, PR #512 as `62a06878`, PR #513 as `5eb844ff`, PR #511 as `52dccc06`, PR #515 as `22767f6d`, PR #516 as `4a0d67e4`, PR #517 as `2c31bcd6`, PR #518 as `00b25acf`, PR #520 as `8d6051a7`, PR #521 as `0a55bcc1`, PR #522 as `d48b0954`, PR #523 as `1d77f4e9`, PR #524 as `cbf75017`, PR #525 as `0f49e772`, PR #526 as `56ae0b24`, PR #527 as `25eac47e`, PR #529 as `1f70727e`, PR #528 as `089d6739`, PR #530 as `536480ae`, PR #536 as `aff8a80f`, PR #537 as `8150750e`, PR #538 as `7f629f57`, PR #539 as `d3a75dca`, PR #540 as `64e3668a`, PR #541 as `772fb22c`, PR #542 as `ed9ee0ee`, PR #543 as `8b44df27`, PR #544 as `3b00d8c1`, PR #546 as `9a3e698e`, PR #547 as `78c56428`, PR #548 as `33c53dc2`, PR #627 as `22391c0d`, PR #628 as `2fe44dd1`, PR #629 as `86843710`, PR #630 as `067340ba`, PR #631 as `42ddb88a`, PR #632 as `696d18ac`, PR #633 as `f8756e60`, PR #634 as `7d3b0cef`, PR #635 as `03e116a0`, PR #636 as `1c798720`, PR #637 as `9d91e2e9`, PR #638 as `97e814cd`, PR #639 as `bdbafb97`, PR #640 as `80f35fe6`, and PR #641 as `7b25b39f`; duplicate PRs #463, #464, and #519 were closed after their stronger sibling branches merged.
>
> Current follow-up note: this pass records PRs #608-#641 covering e2e CI allowlist expansion (now 14 specs), roadmap sync, §33.12 Phase 0 bug fixes (schema drift + deprecated route + version-bump fix), loading spinners + aria-live skeleton accessibility, ErrorBoundary coverage for 11+3 pages (all web pages now covered), §33.12 Phase 1 Tailscale IP auto-detection, §33.12 Phases 3+4 (structured mesh error codes, reverse-registration retry scheduler, async peer update with SSE log streaming, self-identity card, stale peer cleanup, SSRF/ReDoS guards, preflight token check, PeerUpdateLogModal, migration 0029), shared SSRF/ReDoS guard extraction with remaining-instance fixes (PR #627), mesh preflight token wired into add-peer dialog (PR #628), ErrorBoundary on remaining 3 detail pages (PR #629), and real claude-mem import with dedup and preview (PR #630). PR #631 added a confirmation dialog before memory fact deletion. PR #632 synced the roadmap for PRs #627-#630. PR #633 extracted pgPool unconditionally so import routes work without LITELLM_URL. PR #634 fixed responsive graph dimensions and accessibility improvements. PR #635 added security findings management UI (acknowledge, dismiss, GitHub issues). PR #636 standardized empty states across 9 views with shared `EmptyState` component. PR #637 synced the roadmap. PR #638 extracted `DEFAULT_WORKER_PORT` to shared constants. PR #639 added DeploymentView unit tests (18 tests). PR #640 added ConflictsPage unit tests (32 tests). PR #641 made memory browser work without LITELLM_URL. §33.12 Phase 2 now marked delivered (PRs #619/#622: `mesh_local_config` table, `MeshConfigProvider`, `GET/PUT /api/mesh/config`, `MeshConfigSection.tsx` with source badges and write-only token UX). The latest landed main is `3932c341` (v0.7.0); beta/dev CD state remains untouched.
...
### 33.12 Mesh Peering UX & Reliability Overhaul (P0) — In Progress

**Plan:** [plans/2026-04-16-mesh-peering-ux-reliability-overhaul-plan.md](plans/2026-04-16-mesh-peering-ux-reliability-overhaul-plan.md) (v3)
...
| **P0** | Mesh Peering UX & Reliability Overhaul | 33.12 | In progress — Phase 0: ✅ PR #610 (version-bump.sh fix + Drizzle schema drift + deprecate old discover). Phase 1: ✅ PR #617 (Tailscale IP auto-detect with CGNAT validation + selfSyncUrl on /health). Phase 2: ✅ PRs #619/#622 (local-only `mesh_local_config` table + `MeshConfigProvider` for restart-free config + `GET/PUT /api/mesh/config` + Settings → Mesh UI with source badges and write-only token UX + mesh identity settings UI). Phase 3: ✅ PR #623 (structured mesh error codes + preflight token check + SSRF/ReDoS guards + migration 0029). Phase 4: ✅ PR #623 (reverse-registration retry + self-identity card + stale peer cleanup + async peer update with SSE log streaming + PeerUpdateLogModal). See [plans/2026-04-16-mesh-peering-ux-reliability-overhaul-plan.md](plans/2026-04-16-mesh-peering-ux-reliability-overhaul-plan.md). |
...
| [mesh-peer-ux-overhaul-plan](plans/2026-04-15-mesh-peer-ux-overhaul-plan.md) | In progress — PR #550 delivered backend ping diagnostics and PR #551 delivered in-place peer editing; remaining scope is UI diagnostics, Tailscale discovery/probe, and remaining browser coverage | 33.7 |
| [mesh-bidirectional-registration-plan](plans/2026-04-15-mesh-bidirectional-registration-plan.md) | In progress — PR #552 delivered the signed reverse-registration endpoint, PR #554 delivered machine provenance badges, and PR #564 delivered auto-register-on-add plus `/mesh-peers` one-way retry; remaining scope is two-node machine replication proof, mesh health summary, and failure-path browser/integration coverage | 33.8 |
...
| [mesh-schema-protocol-compat-plan](plans/2026-04-15-mesh-schema-protocol-compat-plan.md) | In progress — PR #557 delivered envelope metadata, producer stamping, apply-side schema/protocol gates, compat docs, and unit coverage; remaining scope is operator warning/rejection surfacing plus two-node proof | 33.10 |
| [mesh-fleet-rollout-peer-update-plan](plans/2026-04-15-mesh-fleet-rollout-peer-update-plan.md) | In progress — PR #563 delivered the first PM2 manual update slice (`scripts/peer-update.sh`, signed self-update route, route-local rate limiting, and `/mesh-peers` Update action); remaining scope is Docker fleet activation, CLI dry-run/provenance/rollback, schedulers/settings UI, and two-node coverage | 33.11 |
| [mesh-peering-ux-reliability-overhaul-plan](plans/2026-04-16-mesh-peering-ux-reliability-overhaul-plan.md) | In progress — Phase 0: ✅ PR #610 (bug fixes), Phase 1: ✅ PR #617 (Tailscale IP auto-detect), Phase 2: remaining (local-only `mesh_local_config` table + `MeshConfigProvider` + Settings → Mesh UI), Phase 3: ✅ PR #623 (structured error codes + preflight token + SSRF/ReDoS guards + migration 0029) + PR #627 (shared guard extraction + remaining-instance fixes) + PR #628 (preflight token wired into add-peer dialog), Phase 4: ✅ PR #623 (retry scheduler + self-identity card + stale cleanup + peer update SSE) | 33.12 |
