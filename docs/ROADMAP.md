...
| [multi-agent-collaboration-phase1-impl-plan](plans/2026-03-12-multi-agent-collaboration-phase1-impl-plan.md) | Delivered; sidebar history synced after PR #525 expanded the same nav surface with `g`-prefix Go To chords and grouped Settings shortcut docs | 10.1 |
