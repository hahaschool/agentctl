...
- [ ] Finish the Phase 3 read path over the already-landed fact-source write path: add fact-detail evidence/quote previews plus unavailable-source markers, then legacy rendering/search behavior, then the bounded Surface A (`MEMORY.md`) dry-run bridge.
