...
> Last updated: 2026-03-14 (§15 Codex Runtime Parity added; §14 MCP & Skill Auto-Discovery added)
...
- [ ] Consolidate `DiscoveredSession` type into shared package (3 independent definitions → 1)
- [ ] Add runtime detection to worker session discovery (`.claude/` vs `.codex/` markers)
- [ ] Add `runtime` parameter to session creation API
- [ ] `RuntimeSelector` component (radio + dropdown variants)
- [ ] `RuntimeAwareModelSelect` component (auto-switches model list, auto-resets invalid model)
- [ ] `RuntimeAwareMachineSelect` component (filters by runtime installation via drift API)
...
| **P0** | Codex Parity: Runtime Selector Penetration | 15.1 | Planned |
...
| [runtime-selector-penetration-design](superpowers/specs/2026-03-14-runtime-selector-penetration-design.md) | Planned | 15.1 |
| [runtime-selector-penetration](superpowers/plans/2026-03-14-runtime-selector-penetration.md) | Planned | 15.1 |
