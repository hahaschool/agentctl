...
>
> Current follow-up note: this pass records PRs #608-#617 covering e2e CI allowlist expansion (now 14 specs), roadmap sync, §33.12 Phase 0 bug fixes (schema drift + deprecated route + version-bump fix), loading spinners + aria-live skeleton accessibility, ErrorBoundary coverage for 11 pages, and §33.12 Phase 1 Tailscale IP auto-detection. The latest landed main is `2fe7766e` (v0.5.4); beta/dev CD state remains untouched.
