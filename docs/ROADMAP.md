...
>
> Post-#498 work note: the latest main checkpoint has no open PRs and no open GitHub code-scanning, Dependabot, or secret-scanning alerts. Further work should start from roadmap gaps below and keep using dev-1/dev-2 lanes without touching beta promotion state.
>
