...
- [ ] **Render ping failure details in the UI.** Show the persisted category/status next to the STATUS pill on `/mesh-peers` and include the specific reason in the ping toast.
