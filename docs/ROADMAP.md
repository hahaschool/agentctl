...
| [agent-profiles-web-plan](plans/2026-04-14-agent-profiles-web-plan.md) | Delivered in PR #498 with Playwright follow-up in PR #505 — `/agent-profiles` CRUD page, sidebar entry, API-client module, unit coverage, CI-safe runtime constants, and backend-independent render/create/delete/error browser coverage | 10.2, 20.5 |
