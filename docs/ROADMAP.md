...
- [ ] Synthesis quality — provide human-readable principle candidates, richer examples, and optional model-backed synthesis before calling this feature complete.
