...
- [ ] Import completeness — durable job state plus restart-visible resume/rollback UX is covered through PR #841 and PR #842; edge creation from imported structured fields, broader `claude-mem` source-local idempotency, crash-atomic progress accounting, non-positional JSONL resume cursors, and embedding-similarity dedup remain follow-up work.
