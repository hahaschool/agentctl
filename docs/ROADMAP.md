...
> Coordination note addendum 2: PR #729 merged as `e0f1003a`, PR #730 as `7b90a605`, PR #731 as `243b651f`, PR #732 as `3b3af386`, PR #733 as `3f855d48`, PR #734 as `fbf27801`, PR #735 as `6b5d2f27`, PR #736 as `eebaa49c`, PR #737 as `56b4a598`, PR #738 as `9013a908`, PR #739 as `f91340f5`, PR #740 as `04331fc1`, PR #741 as `ad58a917`, PR #742 as `da0da992`, and PR #743 as `0a29dc69`.
>
...
- [ ] Align the mobile `AuditSummary` client type and tests with the post-#743 backend/web contract (`toolBreakdown`, `actionTypeBreakdown`, `avgDurationMs`) or remove the dead mobile audit-summary wrapper if it is no longer used.
...
| [audit-trail-page-plan](plans/2026-04-14-audit-trail-page-plan.md) | Delivered in PR #507 with browser-depth follow-up in PR #513 and backend contract repair in PR #743 — dedicated `/audit` page, sidebar entry, audit summary/action-list surface, filters/pagination, focused mocked-query unit coverage, backend-independent Playwright coverage in the web E2E CI lane, and `GET /api/audit/summary` returning the frontend-consumed breakdown shape. Follow-up: mobile audit summary type still needs the same contract alignment if retained. | 6.5, 20.5 |
