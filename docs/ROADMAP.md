...
> bringing the latest CI lane to 32 spec files / 118 executed tests.
...
- [ ] **PR G** — Consolidation + synthesis workers, 3 Playwright e2e specs (openai-happy, missing-embedding-alert, gemini-happy), Gate 2 procedure, CHANGELOG + QUICKSTART. `MEMORY_OPS_ENABLED_KINDS` expanded to include consolidation + synthesis. *(branch: `agent/claude-1/feat/memory-ops-pr-g`)*
