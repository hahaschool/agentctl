...
> Grype finding; post-#823 main CI, Security Audit, and Docker publish passed
> at `df12baea`.
...
- [x] Production Docker apt layers, agent-worker libngtcp2 runtime package/cache-bust path, and production Node runtime image pins refreshed after post-#821/post-#822 scanner annotations; dev and beta deployment workflows remain untouched *(PRs #822-#823)*
