...
>
> Post-#825 delta: PR #826 (`595822a4`) synced roadmap and plan docs through the Docker fixed-CVE reporting policy, PR #827 (`7bc1a639`) delivered Memory Operations PR G with consolidation/synthesis worker handlers, env/docs rollout notes, changelog/quickstart updates, and focused unit plus Playwright coverage, and PR #828 (`751fb236`) enabled PostgreSQL `full-drawer` MemoryInjector mode for on-demand facts with source-drawer hydration and global/on-demand tier caps.
>
> GitHub triage on 2026-04-25 has the roadmap current through PR #828. GitHub reported no open PRs after PR #828 merged; post-merge main CI `24921047042`, Security Audit `24921047049`, and Build & Publish Docker Images `24921047038` passed at `751fb236`. Direct alert-list API calls reported 0 open code-scanning, Dependabot, and secret-scanning alerts. Beta is intentionally left on the v0.8.2 promotion stack; the post-beta mainline changes are recorded here for the next full promotion rather than hot-applied into beta.
>
...
> post-#828 main CI, Security Audit, and Docker publish passed at `751fb236`.
