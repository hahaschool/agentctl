...
- [ ] Import completeness — rollback/resume UX, edge creation from imported structured fields, and embedding-similarity dedup remain follow-up work.
...
| **P1** | Unified Memory System UI | 4.8 | Partial — route family, facts browser, dashboard, claude-mem import, hardened basic JSONL history import, JSONL import job provenance plus rollback UI/API (PR #836), basic graph/table, deterministic reports, synthesis lint, maintenance, and core API routes exist. Not complete: durable import resume beyond active in-memory jobs, edge generation from imported observations, embedding-similarity dedup, rich graph Timeline/Clusters/focus/time-lapse, LLM narrative reports, and full consolidation merge/resolution workflows. |
