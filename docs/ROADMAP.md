...
- [x] Add backend-independent `/memory/graph` Playwright coverage for table filters, graph API query parameters, SVG node selection, and node detail rendering *(PR #464)*
...
- [x] Backend-independent `/memory/graph` Playwright coverage for graph rows, table filters, global query params, SVG node selection, and the node detail panel *(PR #464)*
