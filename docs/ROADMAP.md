...
**7,260+ unit tests** across 111+ files + **218+ Playwright e2e checks**, with the backend-independent webhooks, agent-profiles, audit, and machines slices now gated in CI. All packages build and lint cleanly (TypeScript 0 errors, Biome 0 errors).
...
- [x] Backend-independent web Playwright CI gating for `/webhooks`, `/agent-profiles`, `/audit`, and `/machines` using `WEB_PORT`-aware web scripts *(PRs #445, #505, #513, #516)*
