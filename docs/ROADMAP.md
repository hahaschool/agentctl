...
- [x] `scripts/env-up.sh --dry-run` — preview env file, ports, DB/Redis target, and port-conflict report without acquiring the flock or starting services
