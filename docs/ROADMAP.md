...
- [x] Add backend-independent `/memory/scopes` Playwright coverage for scope-tree rendering, create payloads, and delete confirmation/cascade behavior *(PR #463)*
...
- [x] Backend-independent `/memory/scopes` Playwright coverage for scope-tree rendering, create payloads, and delete confirmation/cascade behavior *(PR #463)*
