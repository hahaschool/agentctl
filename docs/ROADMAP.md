...
- [x] Consolidation completeness — restore richer contradiction/near-duplicate merge workflows and clearer post-action state instead of treating the current stale-fact queue as the full design.
*(PR #867)*
