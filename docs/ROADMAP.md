...
- [ ] Add resumable JSONL/claude-mem drawer backfill scripts on top of the persisted state foundation.
...
- [ ] Add first-run contracts for `memory_traverse` when the temporal-graph route ships.
