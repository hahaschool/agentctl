...
describe('KnowledgeGraphView', () => {
  ...
  it('shows Table view by default', () => {
    ...
    // The SVG graph should NOT be visible while in Table mode
    expect(screen.queryByLabelText('Knowledge graph visualization')).toBeNull();
  });
  ...
  it('switches to SVG graph when Graph tab is clicked', () => {
    render(<KnowledgeGraphView />);

    fireEvent.click(screen.getByText('Graph'));

    // SvgGraph renders an <svg> with an accessible label
