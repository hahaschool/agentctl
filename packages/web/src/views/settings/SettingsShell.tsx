  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[240px_minmax(0,1fr)] xl:grid-cols-[260px_minmax(0,1fr)]">
      <aside className="lg:sticky lg:top-6 lg:self-start">
        <div className="rounded-[24px] border border-border/50 bg-card p-4 shadow-lg">
          <div className="mb-4">
...
export function SettingsSection({
  ...
  return (
    <section
      id={id}
      className="scroll-mt-24 rounded-[28px] border border-border/50 bg-card p-5 shadow-lg md:p-6"
    >
