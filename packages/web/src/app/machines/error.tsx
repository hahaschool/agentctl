    ...
    <div className="flex-1 flex flex-col items-center justify-center min-h-[60vh] px-6">
      <Card className="max-w-[460px] w-full">
        <CardContent className="pt-6 text-center">
          ...
          <h1 className="text-xl font-semibold mb-2">Failed to load machines</h1>
          <p className="text-sm text-muted-foreground mb-2">
            The machines list could not be loaded. The server may be unavailable or there may be a
            connection issue.
          </p>
          {error.message && (
