...
export default function RouterConfigError({
  error,
  reset,
}: {
    ...
    <div className="flex-1 flex flex-col items-center justify-center min-h-[60vh] px-6">
      <Card className="max-w-[460px] w-full">
        <CardContent className="pt-6 text-center">
          ...
          <h1 className="text-xl font-semibold mb-2">Failed to load router config</h1>
          <p className="text-sm text-muted-foreground mb-4">
            The router configuration could not be loaded. The LiteLLM proxy may be unavailable.
          </p>
          {error.message && (
            <div className="mb-6">
              <button
