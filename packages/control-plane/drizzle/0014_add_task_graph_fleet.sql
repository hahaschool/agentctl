-- AgentCTL Migration: Task Graph + Fleet (§10.3 Multi-Agent Collaboration Phase 3)
...
CREATE INDEX IF NOT EXISTS "idx_worker_nodes_hostname"
  ON "worker_nodes"("hostname");
...
CREATE INDEX IF NOT EXISTS "idx_agent_instances_profile_id"
  ON "agent_instances"("profile_id");

CREATE INDEX IF NOT EXISTS "idx_agent_instances_worker_id"
  ON "agent_instances"("worker_id");
...
CREATE INDEX IF NOT EXISTS "idx_task_definitions_graph_id"
  ON "task_definitions"("graph_id");
...
CREATE INDEX IF NOT EXISTS "idx_task_edges_to_definition"
  ON "task_edges"("to_definition");
...
CREATE INDEX IF NOT EXISTS "idx_task_runs_definition_id"
  ON "task_runs"("definition_id");

CREATE INDEX IF NOT EXISTS "idx_task_runs_status"
  ON "task_runs"("status");

CREATE INDEX IF NOT EXISTS "idx_task_runs_machine_id"
  ON "task_runs"("machine_id");
