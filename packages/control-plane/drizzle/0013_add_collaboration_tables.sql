-- AgentCTL Migration: Collaboration spaces, threads, events, members, session links
...
CREATE INDEX IF NOT EXISTS "idx_space_events_outbox"
  ON "space_events"("published");
